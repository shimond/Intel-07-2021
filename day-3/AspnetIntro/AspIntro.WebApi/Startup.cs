...
using AspIntro.WebApi.Middlewares;
...
namespace AspIntro.WebApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<IntelCourseDbContext>(x => x.UseInMemoryDatabase("MyIntelDb"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            logger.LogInformation("Configure stated");
            ...
            app.UseSerilogRequestLogging(options=> {
                options.EnrichDiagnosticContext = (diagContext, httpContext) => {
                    diagContext.Set("Accept-INTEL", httpContext.Request.Headers["Accept"].ToString());
                };
            });
